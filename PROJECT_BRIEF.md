...
- 2026-06-05 responsive hero signal rule: keep the full `신호/루틴/라인업` dashboard only on wider desktop layouts. From 980px down, collapse it into a compact `퍼팅 거리 신호` readout so the putting ball, cup-in canvas animation, and mat background remain visible.
