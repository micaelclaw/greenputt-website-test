...
- 2026-06-05 responsive hero signal rule: use only the compact rounded `퍼팅 거리 신호` readout across all browser widths. Do not restore the full `신호/루틴/라인업` dashboard in the hero; the putting ball, cup-in canvas animation, and mat background should stay visually open.
