...
- 2026-05-28 Polvert file organization: use `docs/agent-studio/polvert-file-organization-guide.md` as the version-controlled source of truth for Polvert glove folder structure, product codes, logo/label naming, and AI/final-export file naming. The same guide is mirrored in Google Drive at `05_Product_Polvert_Glove/POLVERT_FILE_ORGANIZATION_GUIDE.md`.
