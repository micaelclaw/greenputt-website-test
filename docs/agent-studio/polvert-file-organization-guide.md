...
PV_PV03_PAIR_WOMEN_DETAIL_INNER_WOOL_BLACK_LOGO_NONE_LABEL_NONE_001.jpg
```
...
PV_PV02_NA_DETAIL_MATERIAL_SHEEPSKIN_WHITE_LOGO_NONE_LABEL_NONE_001.jpg
```
...
PV_PV03_NA_DETAIL_INNER_WOOL_BLACK_LOGO_NONE_LABEL_NONE_001.jpg
```
...
```text
PV_PV01_NA_DETAIL_MATERIAL_MICROFIBER_MESH_WHITE_LOGO_NONE_LABEL_NONE_001.jpg
PV_PV02_NA_DETAIL_MATERIAL_SHEEPSKIN_WHITE_LOGO_NONE_LABEL_NONE_001.jpg
PV_PV03_NA_DETAIL_MATERIAL_WOOL_INNER_BLACK_LOGO_NONE_LABEL_NONE_001.jpg
```
...
```text
03_Final_Exports/PV01_MICROFIBER_MESH/
...
PV_PV03_PAIR_MEN_WINTER_GOLF_BLACK_LOGO_NEW_LABEL_DBK_FINAL_001.jpg
```
...
```text
PV01 극세사 메쉬 기준으로 RH_MEN, WEAR_GRIP, WHITE, LOGO_OLD, LABEL_DBK 최종 이미지를 만들어줘.
```

또는:

```text
PV03 방한장갑 기준으로 PAIR_WOMEN, 겨울 필드 라이프스타일 컷을 만들고, 로고는 LOGO_NEW, 라벨은 LABEL_DBK로 맞춰줘.
```
